...
package ac.sust.saimon.sachetan.heatmap;
...
public class HeatmapTileProvider implements TileProvider {
     ...
     *
     * @param data DataItem set of points to use in the heatmap, as LatLngs.
     ...
     *
     * @param data DataItem to wrap (LatLng)
     * @return DataItem, in WeightedLatLng form
     */
